...
public class CollisionDetector {
    ...
    public boolean collideFromLeft(Integer collider, Integer target) throws NoEntityException, NoComponentException {
    ...
    public boolean collideFromTop(Integer collider, Integer target) throws NoEntityException, NoComponentException {
